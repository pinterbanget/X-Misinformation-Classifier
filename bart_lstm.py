...
if __name__ == '__main__':
    ...
    logger.info("Running Single-Tower BART-LSTM model training...")
    
    # Configuration
    MAX_LEN = 128
    BATCH_SIZE = 128  # 256 for 12G VRAM, 128 for 6G VRAM
    EPOCHS = 100
    LEARNING_RATE = 2e-5
    ...
    # best_model_path = f'models/single_tower_bart_lstm_wo_cn_dt20250314_100char_test_size_0.25_clweight_1_0.25_20250322.pth'
