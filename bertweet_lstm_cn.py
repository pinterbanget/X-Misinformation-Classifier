...
model_name = f"single_tower_bertweet_lstm_{dataset_name}_100char_test_size_{test_size}_clweight_{class_1_weights}"
...
if __name__ == '__main__':
    ...
    logger.info("Running Combined Text BERTWEET-LSTM model training...")
    ...
    # best_model_path = f'models/single_tower_bertweet_lstm_dt20250314_100char_test_size_0.25_clweight_1.5_0.25_20250317.pth'
    ...
    final_model_path = f'models/{model_name}_{test_size}_{datetime.now().strftime("%Y%m%d")}.pth'
    if isinstance(model, DataParallel):
